    ...
    <v-col align="center">
      <v-col class="col-sm-10 col-lg-7">
        <v-card color="grey darken-3" dark style="padding:30px">
          <h1 align="center">Solicitud de Reserva de laboratorios adicionales (Estudiantes)</h1>

          <p
            align="justify"
          >Siga los pasos que se muestran a continuación para realizar la solicitud del laboratorio adicional:</p>
          ...
          <p align="justify">Anexe comprobante de estudiante activo:</p>
           <v-file-input v-model= form.image accept="image/*"></v-file-input>

          <p align="justify">2. Escoja el día que desea realizar el adicional:</p>
          ...
          <p align="justify" >3. Escoja el bloque de horas:</p>
