    ...
    <v-container fluid>
      ...
      <v-col class="col-sm-10 col-lg-7">
        <v-card color="grey darken-3" dark style="padding:30px">
          <h1 align="center">Solicitud de Préstamo de Equipos Interno</h1>

          <p
            align="justify"
          >Siga los pasos que se muestran a continuación para realizar la solicitud del présmato de equipos interno:</p>
